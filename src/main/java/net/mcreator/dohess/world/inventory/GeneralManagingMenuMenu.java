...
public class GeneralManagingMenuMenu extends Container implements DohessModMenus.MenuAccessor {
	...
	public GeneralManagingMenuMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(DohessModMenus.GENERAL_MANAGING_MENU.get(), id);
