...
public class PlayerRankSquadSystemMenu extends Container implements DohessModMenus.MenuAccessor {
	public final Map<String, Object> menuState = new HashMap<String, Object>() {
		@Override
		public Object put(String key, Object value) {
			if (!this.containsKey(key) && this.size() >= 62)
				return null;
	...
	public PlayerRankSquadSystemMenu(int id, PlayerInventory inv, PacketBuffer extraData) {
		super(DohessModMenus.PLAYER_RANK_SQUAD_SYSTEM.get(), id);
