		...
		if (DohessModVariables.WorldVariables.get(world).PD == 0) {
			{
				...
				if (!_ent.world.isRemote() && _ent.world.getServer() != null)
					_ent.world.getServer().getCommandManager().handleCommand(_ent.getCommandSource().withFeedbackDisabled().withPermissionLevel(4), ("tp " + DohessModVariables.WorldVariables.get(world).WarpTc));
			}
		} else {
			{
				Entity _ent = entity;
